...
try:
	with conn.cursor() as cur1: #prepare a cursor object using cursor() method
	...
	conn.close()
# r stores the ip with status down from neutron database
#store the tenant id to k 
...
k=k[0:k.find('\n')]
time.sleep(5)
#add floating ip to created instance
